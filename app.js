  ...
  .then(data => {
    ...
    fetchAndProcessData('pharmacy_names.json')
      .then(pharmacyNames => {
        ...
        // console.log("pharmacy_names",pharmacyNames);
        data.forEach(pharmacy => {
          ...
          // console.log("pharmacy_names_",pharmacyNames.name);
          ...
          if (pharmacy.onDuty) {
            ...
            // const pharmacyLatLng = L.latLng(pharmacy.lat, pharmacy.lon);
            // marker.animate({ color: 'green' }, { duration: 1000, iterations: Infinity });
          }
...
async function fetchAndProcessData(url) {
  ...
  // console.log("fetch_process ",data);
